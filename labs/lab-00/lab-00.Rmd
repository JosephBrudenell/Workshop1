...
```{r setup-tibble}
usernames <- c("wilsonamy", "arty-carty", "username 2", "username 3", "username 4") #Extend if necessary
nums <- c(18, 11, NA, NA, NA) #Extend if necessary
colours <- c("powderblue", "lavender", "colour 2", "colour 2", "colour 4") #Extend if necessary
hobbies <- c("Hiking", "Formula 1", "Hobby 2", "Hobby 3", "Hobby 4") #Extend if necessary
